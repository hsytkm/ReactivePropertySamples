...
namespace ReactivePropertySamples.Views.Pages
{
    ...
    class ObservableCollectionScanViewModel : MyDisposableBindableBase
    {
        public ObservableCollection<ObservableCollectionScanModel> ItemsSource { get; } =
            Enumerable.Range(1, 5).Select(x => new ObservableCollectionScanModel($"Data {x}")).ToObservableCollection();

        public IReadOnlyReactiveProperty<bool> IsUpdated { get; }
        ...
        public ObservableCollectionScanViewModel()
        {
            ...
            //   （View.Eventとのやりとりで OnComplete が来ることはないので、Aggregate の出番はなさそう）
